...
import { createHooks } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/kharrari01/Documents/Sadaqa-Jariya/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/kharrari01/Documents/Sadaqa-Jariya/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kharrari01/Documents/Sadaqa-Jariya","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/kharrari01/Documents/Sadaqa-Jariya/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kharrari01/Documents/Sadaqa-Jariya/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/kharrari01/Documents/Sadaqa-Jariya/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/kharrari01/Documents/Sadaqa-Jariya/.data/kv"}));
...
const _PF4kFOMfCwK9mtdOZsMWOY5hdoKTaiu2jKIWAxBQ650 = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/home/kharrari01/Documents/Sadaqa-Jariya";
...
const _2JTuF9ezD_7J3kAyt0rwEu5Nehsmrby6sJY7iSGSm7c = (nitroApp) => {
...
const plugins = [
  _PF4kFOMfCwK9mtdOZsMWOY5hdoKTaiu2jKIWAxBQ650,
...
const _QoP9i5 = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/kharrari01/Documents/Sadaqa-Jariya/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///home/kharrari01/Documents/Sadaqa-Jariya/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
